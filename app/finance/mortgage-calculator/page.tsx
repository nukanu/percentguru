  ...
  return (
    <>
      ...
      <CalculatorShell
        ...
        intro={<>Enter your home price, down payment, interest rate, and loan term to get the exact monthly payment and total interest over the life of the loan. The loan amount is calculated automatically (home price minus down payment). Most buyers focus on the monthly number — but total interest is equally important: a 30-year loan at 7% on a $240,000 balance costs over $335,000 in interest. Once you know your monthly commitment, the <Link href="/finance/savings-calculator/" className="text-blue-600 hover:underline">savings calculator</Link> can help you model what remains to save each month. For personal loans and car loans, use the <Link href="/finance/loan-payment-calculator/" className="text-blue-600 hover:underline">loan payment calculator</Link>.</>}
