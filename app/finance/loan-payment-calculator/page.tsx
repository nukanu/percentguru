...
const faqs = [
  {
    ...
    answer: "The monthly payment is approximately $193.33. Over 60 months that's $11,599.68 total — $1,599.68 in interest.",
  },
  {
    question: "What is the loan payment formula?",
    answer: "Monthly Payment = P × r × (1 + r)^n / ((1 + r)^n − 1), where P is the loan amount, r is the monthly interest rate (annual rate ÷ 12 ÷ 100), and n is the number of monthly payments.",
  },
  {
    question: "What is the monthly payment on a $20,000 loan at 5% for 36 months?",
    answer: "The monthly payment is approximately $599.42. Total paid over 36 months is around $21,579.12 — $1,579.12 in interest.",
  },
  {
    question: "How does the interest rate affect my monthly payment?",
    answer: "Even a 1% difference in rate can add up significantly over the life of a loan. On a $10,000 loan over 60 months, raising the rate from 5% to 8% increases monthly payments by about $15 and costs roughly $900 more in total interest.",
  },
  {
    question: "What happens if I enter 0% interest?",
    answer: "At 0% interest, the monthly payment is simply the loan amount divided by the number of months — no interest is added. For example, $6,000 at 0% over 24 months is $250/month.",
  },
  {
    question: "How can I reduce the total interest I pay?",
    answer: "Two main levers: lower your interest rate (through better credit, refinancing, or negotiation) or shorten the loan term. A shorter term increases monthly payments but dramatically reduces total interest paid.",
  },
]
  ...
  return (
    <>
      ...
      <CalculatorShell
        ...
        intro="Enter the loan amount, annual interest rate, and term in months to see the exact monthly payment and total interest paid over the life of the loan. Works for personal loans, car loans, or any fixed-rate instalment loan."
        ...
        formulaExplained="P is the loan amount, r is the monthly rate (annual rate ÷ 12 ÷ 100), and n is the number of monthly payments. Multiply total monthly payments by n to get the total amount paid; subtract the principal to find total interest."
        examples={[
        ...
        useCases={[
          "Planning a personal or car loan repayment",
          "Comparing loan offers with different rates and terms",
          "Understanding total interest cost before signing",
          "Budgeting for a new monthly debt obligation",
          "Evaluating the impact of overpaying or refinancing",
        ]}
        faqs={faqs}
      />
    </>
