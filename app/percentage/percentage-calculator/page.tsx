  ...
  return (
    <>
      ...
      <CalculatorShell
        ...
        intro={<>Enter a percentage and a number — the result appears instantly. Used daily for calculating VAT on invoices, tips on restaurant bills, commission on sales, and percentage shares of a budget. One thing worth knowing: this gives you a specific amount, not a rate or ratio — if you need to express one number as a percentage of another, that&apos;s a different calculation. If you know the result but not the original, the <Link href="/percentage/reverse-percentage-calculator/" className="text-blue-600 hover:underline">reverse percentage calculator</Link> handles that.</>}
